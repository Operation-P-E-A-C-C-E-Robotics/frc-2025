...
/**
 * The most epic swerve request ever. Does all the things. Made by the one and only Peaccy. Pheonix Pathplanner Revlib
 ...
 * -Peaccy
 */
public class PeaccyRequest implements LegacySwerveRequest {
